...
class ProductServiceTest {
  ...
  void getProducts() {
    ...
    productRepository.save(ProductCreateRequest.toEntity(product1));
    productRepository.save(ProductCreateRequest.toEntity(product2));
    productRepository.save(ProductCreateRequest.toEntity(product3));
    // when
  ...
  void updateMyPrice() {
    // given
    ProductCreateRequest product = createProduct("title1", "image1", "link1", 10000);
    Product original = productRepository.save(ProductCreateRequest.toEntity(product));
  ...
  void validateMyPrice() {
    ...
    ProductCreateRequest product = createProduct("title1", "image1", "link1", 10000);
    Product product1 = productRepository.save(ProductCreateRequest.toEntity(product));
